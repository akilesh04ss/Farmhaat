          ...
          <div className="viewleft viewbox">
            ...
            <div className="viewcontent">
              ...
              <div className="viewsocial">
                <a href="www.facebook.com" className="viewasoc">
                  <span className="viewspansoc">
                    <FontAwesomeIcon icon={faFacebook} color="white" />
                  </span>
                </a>
                <a href="www.instagram.com" className="viewasoc">
                  <span className="viewspansoc">
                    <FontAwesomeIcon icon={faInstagram} color="white" />
                  </span>
                </a>
                <a href="www.whatsapp.com" className="viewasoc">
                  <span className="viewspansoc">
                    <FontAwesomeIcon icon={faWhatsapp} color="white" />
                  </span>
                </a>
                <a href="www.twitter.com" className="viewasoc">
                  <span className="viewspansoc">
                    <FontAwesomeIcon icon={faTwitter} color="white" />
                  </span>
                </a>
                <a href="www.youtube.com" className="viewasoc">
                  <span className="viewspansoc">
