      ...
      <div className="invhead">
        <div className="invheader">
          ...
          <nav>
            <ul className="invlin">
              <li className="invli">
                <a class="invoce" href="./home.html">
                  Home
                </a>
              </li>
              <li className="invli">
                <a className="invco" href="./product.html">
                  Products
                </a>
              </li>
              <li className="invli">
                <a className="invoc" href="./investors.html">
                  Investors
                </a>
              </li>
              <li className="invli">
                <a className="invo" href="./about.html">
                  About
                </a>
              </li>
            </ul>
            <a className="invcta" href="./feedback.html">
        ...
        <div className="invmaincontent">
          ...
          <div className="invright invbox">
            ...
            <div className="invcontents">
              <ul className="invul2">
                <li className="invli2">
                  <a className="invrighta" href="./home.html">
                    Home
                  </a>
                </li>
                <li className="invli2">
                  <a className="invrighta" href="./feedback.html">
                    Feedback
                  </a>
                </li>
                <li className="invli2">
                  <a className="invrighta" href="./product.html">
                    Product
                  </a>
                </li>
                <li className="invli2">
                  <a className="invrighta" href="./investors.html">
                    Investor
                  </a>
                </li>
                <li className="invli2">
                  <a className="invrighta" href="./register.html">
                    Register
                  </a>
                </li>
              </ul>
