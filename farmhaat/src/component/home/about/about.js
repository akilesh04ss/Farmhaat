...
<div>
    <div className="head">  
       <div className="lj">
            ...
            <nav>
                <ul className="lin">
                    <li><a className="oce" href="./home.html">Home</a></li>
                ...
                <a className = "cta" href="#"><button>Log out</button></a>
    ...
    <div className="our">
        <p>Profile</p>
        <div><img src="./grow1.png" alt="Mision" class="mis"/></div>
        <p className="misi">MISSION</p>
        <br></br>
    <br></br><p className="enter">To provide 100% pure and organic products and to make the consumer satisfied. To be a globally competitive producer.</p>
    </div>
    <div>
        <img src="./prepare1.png" alt="Vision" class="vis"/>
        <p className="visi">VISION</p><br></br>
        <br></br>
        <p className="venter">
            To expand the company and setup branches allover the parts of world. To handle al knds of waste in an effective way with 0% wastage.
        </p>
    </div>    
    <div className="profile">
        ...
        The fertilizers are ideal for soil improvement, optimizing crop yields and<br></br>making plants healthier in an eco-friendly manner while reducing the use of any chemical fertilizer.
